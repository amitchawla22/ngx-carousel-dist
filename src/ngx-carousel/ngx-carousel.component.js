import { Component, ElementRef, Renderer, Input, Output, HostListener, EventEmitter } from '@angular/core';
var NgxCarouselComponent = /** @class */ (function () {
    ...
    NgxCarouselComponent.prototype.storeCarouselData = function () {
        ...
        if (this.data.type === 'responsive') {
            this.data.deviceType =
                this.data.deviceWidth >= this.lg ? 'lg' :
                    this.data.deviceWidth >= this.md ? 'md' :
                        this.data.deviceWidth >= this.sm ? 'sm' :
                            'xs';
            this.data.items = +(this.data.deviceWidth >= this.lg ? this.userData.grid.lg :
                this.data.deviceWidth >= this.md ? this.userData.grid.md :
                    this.data.deviceWidth >= this.sm ? this.userData.grid.sm :
    ...
    NgxCarouselComponent.prototype.carouselSize = function () {
        ...
        if (this.data.type === 'responsive') {
            ...
            itemStyle = "@media (max-width:" + (this.sm - 1) + "px){" + itemWidth_xs + "}\n                    @media (min-width:" + this.sm + "px){" + itemWidth_sm + "}\n                    @media (min-width:" + this.md + "px){" + itemWidth_md + "}\n                    @media (min-width:" + this.lg + "px){" + itemWidth_lg + "}";
        }
        else {
